...
/* USER CODE BEGIN PV */
volatile uint32_t blinkInterval = 1000; // Інтервал миготіння в мс (1000 мс за замовчуванням)
volatile uint8_t activeLeds = 0; // Бітова маска активних діодів (0 - всі вимкнені)
